...
import contralador.CtrlUsuario;
...
public class FrmLogin extends javax.swing.JFrame {
    ...
    public FrmLogin() {
        ...
        this.setTitle("Login - sitemaVentas");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 0, 350, 500));
...
private void Login(){
    if (!txt_usuario.getText().isEmpty() && !txt_password.getText().isEmpty()) {
        ...
        JOptionPane.showMessageDialog(null, "Ingreses Sus Credenciales");
    }
}
}
